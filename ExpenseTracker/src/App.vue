...
<div class="container">
    <div class="header">
        ...
        <div class="balance-container">
            <h2>Your Balance</h2>
            <h2 id="balance" class="balance" v-if="income!=''">{{income}}</h2>
            <h2 id="balance" class="balance" v-else>$0.00</h2>
        </div>
    </div>
    <h3>History</h3>
    <ul id="list" class="list">
        <li v-for="(item,id) in transaction" :key="id">
            {{item.text}}
            {{item.amount}}
        </li>
    </ul>
    ...
    <form id="form">
        ...
        <button class="btn" @click="add">Add transaction</button>
    </form>
</div>
    ...
    methods: {
        add(e) {
            ...
            Object.keys(this.transaction).forEach(key => {
                ...
                x[key]= this.transaction[key].amount;
            });
            var sum = 0;
